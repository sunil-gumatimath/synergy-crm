...
-- The remote project already had this version recorded, so this file exists
-- locally to keep `supabase db push` aligned with the remote history.
-- The final live RPC behavior is amended by later migrations:
