-- Historical base migration for the employee-create RPC.
-- The live project also has an earlier reconciled version under 20260409123740.
-- Keep both versions in source control because both are present in the remote
-- migration history. Later fixes are applied in:
--   20260409190000_fix_admin_create_employee_trigger_conflict.sql
